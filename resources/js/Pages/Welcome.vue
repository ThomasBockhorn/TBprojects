      ...
      <div id="main" class="mt-20">
        ...
        <div class="m-20">
          ...
          <p class="text-2xl m-5">
            ...
            web development. To further my education, I took and continue to
            take Udemy courses for both front-end and back-end development. The
          ...
          <p class="text-2xl m-5">
            ...
            how essential the human connection is. History and websites can be
            dry and boring, or can be interesting and compelling. It all depends
